...
# (project=scitex-io, owner=ywatanabe1989, repo=scitex-io,
...
TMPDIR="/tmp/publish-scitex_io-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-io dist/* uploaded to PyPI via manual OIDC trusted publishing"
